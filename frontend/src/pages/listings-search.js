...
function initializeSearch() {
  ...
  function createListingCard(listing) {
    ...
    cardHTML += '<div class="relative h-48 bg-gray-200 overflow-hidden">'
    if (hasImage) {
      cardHTML += '<img data-src="' + imageUrl + '" alt="' + listing.brand + ' ' + listing.model + '" class="lazy-image w-full h-full object-cover" loading="lazy" onerror="this.onerror=null; this.src=\'https://via.placeholder.com/600x400?text=' + encodeURIComponent(listing.brand + ' ' + listing.model) + '\'; this.classList.add(\'opacity-50\')">'

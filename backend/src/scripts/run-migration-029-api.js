#!/usr/bin/env node
/**
 * Run migration 029 (Marktplaats source) via Supabase Management API
...
async function main() {
  ...
  const sql = fs.readFileSync(
    path.join(__dirname, '../database/migrations/029_add_marktplaats_source_to_auto_scrapers.sql'),
    'utf8'
  );
  ...
  console.log('✅ Migration 029 applied (Marktplaats source)');
}

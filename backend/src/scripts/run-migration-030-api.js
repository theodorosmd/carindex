#!/usr/bin/env node
/**
 * Run migration 030 (listing_sources - multiple links per listing) via Supabase Management API
...
async function main() {
  ...
  const sql = fs.readFileSync(
    path.join(__dirname, '../database/migrations/030_add_listing_sources.sql'),
    'utf8'
  );
  ...
  console.log('✅ Migration 030 applied (listing_sources - multiple links per listing)');
}

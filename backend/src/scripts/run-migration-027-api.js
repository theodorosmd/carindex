#!/usr/bin/env node
/**
 * Run migration 027 (otomoto source) via Supabase Management API
...
async function main() {
  ...
  const sql = fs.readFileSync(
    path.join(__dirname, '../database/migrations/027_add_otomoto_source_to_auto_scrapers.sql'),
    'utf8'
  );
  ...
  console.log('✅ Migration 027 applied (otomoto source)');
}

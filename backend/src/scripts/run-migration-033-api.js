#!/usr/bin/env node
/**
 * Run migration 033 (arbitrage_opportunities_detected table)
...
async function main() {
  ...
  const sql = fs.readFileSync(
    path.join(__dirname, '../database/migrations/033_arbitrage_opportunities_detected.sql'),
    'utf8'
  );
  ...
  console.log('✅ Migration 033 applied (arbitrage_opportunities_detected)');
}

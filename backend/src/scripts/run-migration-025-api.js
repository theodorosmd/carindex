#!/usr/bin/env node
/**
 * Run migration 025 (coches.net + gaspedaal sources) via Supabase Management API
...
async function main() {
  ...
  const sql = fs.readFileSync(
    path.join(__dirname, '../database/migrations/025_add_cochesnet_source_to_auto_scrapers.sql'),
    'utf8'
  );
  ...
  console.log('✅ Migration 025 applied (coches.net + gaspedaal sources)');
}

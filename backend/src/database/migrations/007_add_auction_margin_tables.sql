...
CREATE TABLE IF NOT EXISTS auction_listings (
    ...
    source VARCHAR(50) NOT NULL, -- e.g., 'kvd', 'swedish_auction'
...
CREATE TABLE IF NOT EXISTS comparable_listings (
    ...
    seller_type VARCHAR(20), -- 'pro' or 'part'
    raw_json JSONB,
    match_score DECIMAL(4,3) DEFAULT 0, -- 0.000 to 1.000
...
CREATE TABLE IF NOT EXISTS margin_calculations (
    ...
    target_departments INTEGER[] NOT NULL, -- e.g., [13,83,06,84,34,30]
    selected_comparables UUID[] DEFAULT ARRAY[]::UUID[], -- array of comparable_listings.id
